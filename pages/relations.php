<html>
	<head>
		<title>Les Relations amoureuses</title>
		<meta charset="utf-8" />
	...
	<div class="w3-container w3-row-padding">
		...
		<h1>Les Relations amoureuses</h1>
		...
		<?php
			...
			$file = fopen("../base_de_donnees/relations.txt", "r");
			$filename = "../base_de_donnees/relations.txt";
		...
		if (isset($_GET['submit_message'])) //permet de vérifier si le bouton d'inscription a bien été cliqué
		{
			...
			<html> 
			<head> 
			<meta http-equiv=\"refresh\" content=\"0; url=relations.php\"> 
			</head> 
			</html>"; 
